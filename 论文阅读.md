...
- **Language models as zero-shot planners: Extracting actionable knowledge for embodied agents** [link](https://proceedings.mlr.press/v162/huang22a.html)
## 强化学习
...
- **Teaching large language models to self-debug**.  [link](https://arxiv.org/abs/2304.05128)
...
## Agents
- **Language Agents: Foundations, Prospects, and Risks**  [link](https://aclanthology.org/2024.emnlp-tutorials.3/)
